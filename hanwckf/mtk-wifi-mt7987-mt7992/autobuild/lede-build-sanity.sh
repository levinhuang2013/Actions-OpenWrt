...
copy_mt76_firmware() {
	...
	cp -rf ${FW_SOURCE_DIR}/firmware/mt7996/rebb/WIFI_MT7990_WACPU_RAM_CODE_1_1.bin ${FW_SOURCE_DIR}/src/firmware/mt7996/mt7996_wa.bin
	cp -rf ${FW_SOURCE_DIR}/firmware/mt7996/rebb/WIFI_RAM_CODE_MT7990_1_1.bin ${FW_SOURCE_DIR}/src/firmware/mt7996/mt7996_wm.bin
	cp -rf ${FW_SOURCE_DIR}/firmware/mt7996/rebb/WIFI_MT7990_PATCH_MCU_1_1_hdr.bin ${FW_SOURCE_DIR}/src/firmware/mt7996/mt7996_rom_patch.bin
	cp -rf ${FW_SOURCE_DIR}/firmware/mt7996/rebb/WIFI_MT7990_PHY_RAM_CODE_1_1.bin ${FW_SOURCE_DIR}/src/firmware/mt7996/mt7996_dsp.bin
	cp -rf ${FW_SOURCE_DIR}/firmware/mt7996/rebb/WIFI_RAM_CODE_MT7990_1_1_TESTMODE.bin ${FW_SOURCE_DIR}/src/firmware/mt7996/mt7996_wm_tm.bin

	cp -rf ${FW_SOURCE_DIR}/firmware/mt7996/rebb/2adie_triband/WIFI_MT7990_WACPU_RAM_CODE_1_1.bin ${FW_SOURCE_DIR}/src/firmware/mt7996/mt7996_wa_233.bin
	cp -rf ${FW_SOURCE_DIR}/firmware/mt7996/rebb/2adie_triband/WIFI_RAM_CODE_MT7990_1_1.bin ${FW_SOURCE_DIR}/src/firmware/mt7996/mt7996_wm_233.bin
	cp -rf ${FW_SOURCE_DIR}/firmware/mt7996/rebb/2adie_triband/WIFI_MT7990_PATCH_MCU_1_1_hdr.bin ${FW_SOURCE_DIR}/src/firmware/mt7996/mt7996_rom_patch_233.bin
	cp -rf ${FW_SOURCE_DIR}/firmware/mt7996/rebb/2adie_triband/WIFI_RAM_CODE_MT7990_1_1_TESTMODE.bin ${FW_SOURCE_DIR}/src/firmware/mt7996/mt7996_wm_tm_233.bin
	...
	cp -rf ${FW_SOURCE_DIR}/firmware/mt7990/rebb/WIFI_MT7993_PATCH_MCU_1_1_hdr.bin ${FW_SOURCE_DIR}/src/firmware/mt7996/mt7990_rom_patch.bin
	cp -rf ${FW_SOURCE_DIR}/firmware/mt7990/rebb/WIFI_RAM_CODE_MT7993_1_1.bin ${FW_SOURCE_DIR}/src/firmware/mt7996/mt7990_wm.bin
	cp -rf ${FW_SOURCE_DIR}/firmware/mt7990/rebb/WIFI_RAM_CODE_MT7993_1_1_TESTMODE.bin ${FW_SOURCE_DIR}/src/firmware/mt7996/mt7990_wm_tm.bin
}

prepare_mac80211_src() {
	package_dir=$1
	to_src=${package_dir}/$2
	from_src=${BUILD_DIR}/./../mac80211_package/$3

	rm -rf ${to_src}
	cp -rf ${from_src} ${to_src}
	rm -rf ${to_src}/.git
	ln -s ${from_src}/.git ${to_src}/.git
	cd ${to_src}
	git fetch gerrit --unshallow
	cd -
	mv ${package_dir}/patches ${package_dir}/patches_bak
}
...
prepare_mac80211_release () {
	if [ "$1" = "1" ]; then
		...
		prepare_mac80211_src "${BUILD_DIR}/package/kernel/mt76" "src" "wifi7_mt76_src"
		copy_mt76_firmware

		# Remove mtk internal patches and follow gateway/WiFi7/mac80211/backport source folder
		prepare_mac80211_src "${BUILD_DIR}/package/kernel/mac80211" "src" "wifi7_backport_src"

		# Remove mtk internal patches and follow gateway/WiFi7/mac80211/hostapd source folder
		prepare_mac80211_src "${BUILD_DIR}/package/network/services/hostapd" "src" "wifi7_hostapd_src"
		cp -rf ${release_folder}/mt7988_wifi7_mac80211_mlo/package/network/services/hostapd/files/* ${BUILD_DIR}/package/network/services/hostapd/files/

		# Remove mtk internal patches and follow gateway/WiFi7/mac80211/iw source folder
		prepare_mac80211_src "${BUILD_DIR}/package/network/utils/iw" "src" "wifi7_iw_src"

		# Follow gateway/WiFi7/mac80211/wifi-scripts files folder
		# Since wifi-scripts folder doesn't exist in the original openwrt-21.02 folder, do mkdir to prevent command failed
		mkdir -p ${BUILD_DIR}/package/network/config/wifi-scripts
		prepare_mac80211_src "${BUILD_DIR}/package/network/config/wifi-scripts" "files" "wifi7_wifi_scripts_src"
		cp -rf ${BUILD_DIR}/./../mac80211_package/wifi7_wifi_scripts_src/hostapd/* ${BUILD_DIR}/package/network/services/hostapd/files/
	fi
}
