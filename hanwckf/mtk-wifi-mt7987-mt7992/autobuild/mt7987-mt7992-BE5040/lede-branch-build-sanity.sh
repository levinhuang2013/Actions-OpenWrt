...
branch_name=mt7987-mt7992-BE5040
branch_path=autobuild/mt7987-mt7992-BE5040
...
mt7988d=1
mt7988a_88d=0
ap_driver_version="8.2.2.2"
be5040_config=${branch_path}/files/be5040.config
...
mv ${BUILD_DIR}/package/libs/mtk_libnl-tiny ${BUILD_DIR}/package/libs/libnl-tiny

	rm -rf ${BUILD_DIR}/package/network/utils/iw
mv ${BUILD_DIR}/package/network/utils/mtk_iw ${BUILD_DIR}/package/network/utils/iw

	rm -rf ${BUILD_DIR}/package/network/utils/iwinfo
mv ${BUILD_DIR}/package/network/utils/mtk_iwinfo ${BUILD_DIR}/package/network/utils/iwinfo
...
#	}
	...
	cat ${be5040_config} >> ${default_sdk_config}
	return 0
}
