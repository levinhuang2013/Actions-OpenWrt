...
branch_name=mt7987-mt7992-BE6500
branch_path=autobuild/mt7987-mt7992-BE6500
...
mt7988d=1
mt7988a_88d=0
ap_driver_version="8.2.3.2"
be6500_config=${branch_path}/files/be6500.config
...
#	}
	...
	cat ${be6500_config} >> ${default_sdk_config}
	return 0
}
