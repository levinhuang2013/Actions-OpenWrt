								...
								if (reg_class[i].spacing == BW_80 || reg_class[i].spacing == BW_160) {
									if (pChCtrl->ChList[m].Channel ==
										...
										cac_cap->opcap[l].non_occupancy_remain[k] =
											(pChCtrl->ChList[m].NonOccupancy == 0) ?
											pChCtrl->ChList[m].NOPSaveForClear :
	...
	wdev_op_class_info_ext *op_class)
{
	...
	for (i = 1;; i++) {
		...
		if (WMODE_CAP_AC(PhyMode)) {
			...
			if (vht_bw != VHT_BW_160 && reg_class_vht[i].global_class == 129)
				continue;
			if (vht_bw < VHT_BW_80 && reg_class_vht[i].global_class == 128)
				continue;
			if (vht_bw != VHT_BW_8080 && reg_class_vht[i].global_class == 130)
				continue;

			if (ht_bw != HT_BW_40 && ((reg_class_vht[i].global_class == 116) || (reg_class_vht[i].global_class == 117) ||
				(reg_class_vht[i].global_class == 119) || (reg_class_vht[i].global_class == 120) ||
				(reg_class_vht[i].global_class == 122) || (reg_class_vht[i].global_class == 123) ||
				(reg_class_vht[i].global_class == 126) || (reg_class_vht[i].global_class == 127) ||
				(reg_class_vht[i].global_class == 83) || (reg_class_vht[i].global_class == 84)))
				continue;
			...
			if ((reg_class_vht[i].global_class >= OP_CLASS_81 &&
				...
				for (j = 0; j <= 14; j++) {
					...
					if (WMODE_CAP_5G(PhyMode)) {
						...
						if (op_class->opClassInfoExt[op_index].op_class > OP_CLASS_127) {
						while (pChDesc->FirstChannel) {
							if ((reg_class_vht[i].center_freq[j] >= pChDesc->FirstChannel) &&
								(reg_class_vht[i].center_freq[j] < (pChDesc->FirstChannel + (4*pChDesc->NumOfCh)))) {
								max_priority = get_max_prio_channel_list(pAd, pChDesc->FirstChannel, pChDesc->NumOfCh);
								if (max_priority > 14) {
									MTWF_DBG(NULL, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_DEBUG,
										"%s channel Case1 MAX PRIO GREATER THAN 14\n", __func__);
			...
			if (ht_bw != HT_BW_40 && ((reg_class[i].global_class == 116) || (reg_class[i].global_class == 117) ||
				(reg_class[i].global_class == 119) || (reg_class[i].global_class == 120) ||
				(reg_class[i].global_class == 122) || (reg_class[i].global_class == 123) ||
				(reg_class[i].global_class == 126) || (reg_class[i].global_class == 127) ||
				(reg_class[i].global_class == 83) || (reg_class[i].global_class == 84)))
				continue;
	...
	wdev_op_class_info *op_class)
{
	...
	for (i = 1;; i++) {
		...
		if (WMODE_CAP_BE(PhyMode)) {
			...
			if (WMODE_CAP_BE(PhyMode)) {
				if (eht_bw != EHT_BW_160 && reg_class_he_eht[i].global_class == 129)
					continue;

				if (eht_bw < EHT_BW_80 && reg_class_he_eht[i].global_class == 128)
					continue;
			} else {
				...
				if (vht_bw != VHT_BW_8080 && reg_class_he_eht[i].global_class == 130)
					continue;
			}

			if (ht_bw != HT_BW_40 && ((reg_class_he_eht[i].global_class == 116) || (reg_class_he_eht[i].global_class == 117) ||
				(reg_class_he_eht[i].global_class == 119) || (reg_class_he_eht[i].global_class == 120) ||
				(reg_class_he_eht[i].global_class == 122) || (reg_class_he_eht[i].global_class == 123) ||
				(reg_class_he_eht[i].global_class == 126) || (reg_class_he_eht[i].global_class == 127) ||
				(reg_class_he_eht[i].global_class == 83) || (reg_class_he_eht[i].global_class == 84)))
				continue;
