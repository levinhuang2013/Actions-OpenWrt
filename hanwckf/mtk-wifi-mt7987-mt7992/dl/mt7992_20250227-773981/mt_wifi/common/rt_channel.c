...
CH_DESC Country_Region1_ChDesc_2GHZ[] = {
	{1, 13, 2402, 2482, CHANNEL_DEFAULT_PROP},
	{}
};

CH_DESC Country_Region2_ChDesc_2GHZ[] = {
	{10, 2, 2447, 2472, CHANNEL_DEFAULT_PROP},
	{}
};

CH_DESC Country_Region3_ChDesc_2GHZ[] = {
	{10, 4, 2447, 2482, CHANNEL_DEFAULT_PROP},
	{}
};

CH_DESC Country_Region4_ChDesc_2GHZ[] = {
	{14, 1, 2474, 2494, CHANNEL_DEFAULT_PROP},
	{}
};

CH_DESC Country_Region5_ChDesc_2GHZ[] = {
	{1, 14, 2402, 2494, CHANNEL_DEFAULT_PROP},
	{}
};

CH_DESC Country_Region6_ChDesc_2GHZ[] = {
	{3, 7, 2412, 2462, CHANNEL_DEFAULT_PROP},
	{}
};

CH_DESC Country_Region7_ChDesc_2GHZ[] = {
	{5, 9, 2422, 2485, CHANNEL_DEFAULT_PROP},
	{}
};

CH_DESC Country_Region31_ChDesc_2GHZ[] = {
	{1, 11, 2402, 2475, CHANNEL_DEFAULT_PROP},
	{12, 3, 2457, 2487, CHANNEL_PASSIVE_SCAN},
	{}
};

CH_DESC Country_Region32_ChDesc_2GHZ[] = {
	{1, 11, 2402, 2472, CHANNEL_DEFAULT_PROP},
	{12, 2, 2457, 2482, CHANNEL_PASSIVE_SCAN},
	{}
};
...
CH_DESC Country_Region0_ChDesc_5GHZ[] = {
	{36, 8, 5170, 5330, CHANNEL_DEFAULT_PROP},
	{149, 5, 5735, 5835, CHANNEL_DEFAULT_PROP},
	{}
};

CH_DESC Country_Region1_ChDesc_5GHZ[] = {
	{36, 8, 5170, 5330, CHANNEL_DEFAULT_PROP},
	{100, 11, 5400, 5710, CHANNEL_DEFAULT_PROP},
	{}
};
...
CH_DESC Country_Region3_ChDesc_5GHZ[] = {
	{52, 4, 5250, 5330, CHANNEL_DEFAULT_PROP},
	{149, 4, 5735, 5815, CHANNEL_DEFAULT_PROP},
	{}
};
...
CH_DESC Country_Region6_ChDesc_5GHZ[] = {
	{36, 4, 5170, 5250, CHANNEL_DEFAULT_PROP},
	{}
};
...
CH_DESC Country_Region9_ChDesc_5GHZ[] = {
	{36, 8, 5170, 5330, CHANNEL_DEFAULT_PROP},
	{100, 5, 5490, 5590, CHANNEL_DEFAULT_PROP},
	{132, 3, 5650, 5710, CHANNEL_DEFAULT_PROP},
	{149, 5, 5735, 5835, CHANNEL_DEFAULT_PROP},
	{}
};
...
CH_DESC Country_Region11_ChDesc_5GHZ[] = {
	{36, 8, 5170, 5330, CHANNEL_DEFAULT_PROP},
	{100, 6, 5400, 5610, CHANNEL_DEFAULT_PROP},
	{149, 4, 5735, 5815, CHANNEL_DEFAULT_PROP},
	{}
};
...
CH_DESC Country_Region12_ChDesc_5GHZ[] = {
	{36, 8, 5170, 5330, CHANNEL_DEFAULT_PROP},
	{100, 12, 5490, 5730, CHANNEL_DEFAULT_PROP},
	{}
};
...
CH_DESC Country_Region14_ChDesc_5GHZ[] = {
	{36, 8, 5170, 5330, CHANNEL_DEFAULT_PROP},
	{100, 5, 5490, 5590, CHANNEL_DEFAULT_PROP},
	{132, 4, 5650, 5730, CHANNEL_DEFAULT_PROP},
	{149, 5, 5735, 5835, CHANNEL_DEFAULT_PROP},
	{}
};

CH_DESC Country_Region15_ChDesc_5GHZ[] = {
	{149, 7, 5735, 5875, CHANNEL_DEFAULT_PROP},
	{}
};
...
CH_DESC Country_Region19_ChDesc_5GHZ[] = {
	{56, 3, 5270, 5330, CHANNEL_DEFAULT_PROP},
	{100, 11, 5400, 5710, CHANNEL_DEFAULT_PROP},
	{149, 4, 5735, 5815, CHANNEL_DEFAULT_PROP},
	{}
};
...
CH_DESC Country_Region20_ChDesc_5GHZ[] = {
	{36, 8, 5170, 5330, CHANNEL_DEFAULT_PROP},
	{100, 7, 5490, 5630, CHANNEL_DEFAULT_PROP},
	{149, 4, 5735, 5815, CHANNEL_DEFAULT_PROP},
	{}
};
...
CH_DESC Country_Region24_ChDesc_5GHZ[] = {
	{100, 12, 5400, 5730, CHANNEL_DEFAULT_PROP},
	{}
};
...
CH_DESC Country_Region25_ChDesc_5GHZ[] = {
	...
	{100, 5, 5490, 5590, CHANNEL_DEFAULT_PROP},
	{132, 3, 5650, 5710, CHANNEL_DEFAULT_PROP},
	{149, 8, 5735, 5895, CHANNEL_DEFAULT_PROP},
	{}
};
...
CH_DESC Country_Region38_ChDesc_5GHZ[] = {
	{182, 0, 4910, 5900, CHANNEL_DEFAULT_PROP}, /* the second parm is unvaild */
	{}
};
#endif /* NON_WIFI_FREQ_5MHZ_SHIFT_SUPPORT */
...
CH_DESC Country_Region0_ChDesc_6GHZ[] = {
	{1, 24, 5945, 6425, CHANNEL_DEFAULT_PROP},
	{97, 5, 6425, 6525, CHANNEL_DEFAULT_PROP},
	{117, 18, 6525, 6885, CHANNEL_DEFAULT_PROP},
	{189, 12, 6885, 7125, CHANNEL_DEFAULT_PROP},
	{}
};
...
#ifdef NON_WIFI_FREQ_5MHZ_SHIFT_SUPPORT
CH_DESC Country_Region8_ChDesc_6GHZ[] = {
	{145, 0, 5725, 7125, CHANNEL_DEFAULT_PROP}, /* the first & second parm is invalid*/
	{}
};
#endif /* NON_WIFI_FREQ_5MHZ_SHIFT_SUPPORT */
...
#ifdef NON_WIFI_FREQ_5MHZ_SHIFT_SUPPORT
	{REGION_8_A_BAND_6GHZ, Country_Region8_ChDesc_6GHZ},
#endif /* NON_WIFI_FREQ_5MHZ_SHIFT_SUPPORT */
	{}
};
...
void remove_mlo_csa(RTMP_ADAPTER *pAd, struct wifi_dev *wdev)
{
	...
	if (bss_mngr_is_wdev_in_mlo_group(wdev)) {
		if (bss_mngr_mld_remove_sta_profile(wdev,
			...
			MTWF_DBG(pAd, DBG_CAT_MLO, CATMLO_BMGR, DBG_LVL_NOTICE,
				"remove_sta_profile suc.\n");
		else
			MTWF_DBG(pAd, DBG_CAT_MLO, CATMLO_BMGR, DBG_LVL_NOTICE,
				"no need to remove_sta_profile.\n");

		/* Will do other ie update after remove csa, no need to do here */
...
UINT32 mwctl_bw_2_rf_bw(UINT32 mwctl_bw)
{
	UINT32 rf_bw = BW_20;

	if (mwctl_bw == MWCTL_CHAN_WIDTH_40)
		rf_bw = BW_40;
	else if (mwctl_bw == MWCTL_CHAN_WIDTH_80)
		rf_bw = BW_80;
	else if (mwctl_bw == MWCTL_CHAN_WIDTH_160)
		rf_bw = BW_160;
	else if (mwctl_bw == MWCTL_CHAN_WIDTH_320)
		rf_bw = BW_320;
	...
	*/
	...
	for (idx = 0; idx < WDEV_NUM_MAX; idx++) {
		...
		if (tdev && HcIsRadioAcq(tdev)
			...
			MacTableResetNonMapWdev(pAd, tdev, TRUE);
	}
...
/*
	...
	==========================================================================
*/
INT update_bw_config(RTMP_ADAPTER *pAd, struct wifi_dev *wdev, UINT32 new_bw)
{
	struct wifi_dev *tdev = NULL;
	UCHAR i = 0;
	...
	case BW_320:
		...
		break;
	default:
		/*Make sure variables are initialized in all cases*/
		MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_ERROR,
			"%s: Invalid bandwidth (%d), initializing as BW 20!\n", __func__, new_bw);
		ht_bw = HT_BW_20;
		vht_bw = VHT_BW_2040;
		eht_bw = EHT_BW_20;
		break;
	...
	UCHAR bypass_cac)
{
	...
	MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_NOTICE,
		"End. set_flag=0x%x, set_flag=%d, chan=%d, ext_chan=%d, bw=%d, ht_coex=%d, bypass_cac=%d\n",
		set_flag, set_flag, chan, ext_chan, bw, ht_coex, bypass_cac);
	...
	if ((set_flag & MTK_CFG80211_CHAN_SET_FLAG_CHAN) && !IsValidChannel(pAd, chan, wdev)) {
		MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_ERROR,
	...
	new_ch = wdev->channel;
	new_bw = wlan_operate_get_bw(wdev);
	old_ch = wdev->channel;
	...
	if (set_flag & MTK_CFG80211_CHAN_SET_FLAG_CHAN) {
		if (chan != wdev->channel) {
			new_ch = chan;
			b_chn_change = TRUE;
		} else if (old_bw != get_channel_bw_cap(wdev, chan)) {
			new_ch = chan;
			b_chn_change = TRUE;
		}
	}
	...
	if (set_flag & MTK_CFG80211_CHAN_SET_FLAG_BW) {
		b_bw_change = TRUE;
		bw = mwctl_bw_2_rf_bw(bw);
		err_code = update_bw_config(pAd, wdev, bw);
		if (err_code) {
			MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_ERROR,
				"update bw failed!\n");
			return err_code;
	...
	if (set_flag & MTK_CFG80211_CHAN_SET_FLAG_BYPASS_CAC) {
		if (bypass_cac == 0 && pAd->CommonCfg.DfsParameter.bDfsEnable) {
	...
	if (b_chn_change) {
		...
		/*To do set new bw, need TakeChannelOpCharge first*/
		if (!TakeChannelOpCharge(pAd, wdev, CH_OP_OWNER_SET_CHN, TRUE)) {
			MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_ERROR,
				"TakeChannelOpCharge fail for SET bw!\n");
			return -EBUSY;
		}

		/*reset set_ch_async_flag first*/
		pAd->ApCfg.set_ch_async_flag = FALSE;
		...
		/*non-async flow should release ch op here*/
		if (pAd->ApCfg.set_ch_async_flag == FALSE)
			ReleaseChannelOpCharge(pAd, wdev, CH_OP_OWNER_SET_CHN);

	} else if (b_coex_change) {
		/*To do set new coex, need TakeChannelOpCharge first*/
		if (!TakeChannelOpCharge(pAd, wdev, CH_OP_OWNER_SET_CHN, TRUE)) {
			MTWF_DBG(pAd, DBG_CAT_CHN, CATCHN_CHN, DBG_LVL_ERROR,
				"TakeChannelOpCharge fail for SET bw!\n");
			return -EBUSY;
