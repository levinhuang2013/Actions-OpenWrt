...
VOID mlr_init(RTMP_ADAPTER *pAd)
{
	...
	MTWF_DBG(pAd, DBG_CAT_MLR, CATMLR_CFG, DBG_LVL_NOTICE,
		"Enable: %d, Ver: 0x%x\n",
		pAd->CommonCfg.bMLREnable, pAd->CommonCfg.MLRVersion);
}
#endif /* MLR_SUPPORT */
