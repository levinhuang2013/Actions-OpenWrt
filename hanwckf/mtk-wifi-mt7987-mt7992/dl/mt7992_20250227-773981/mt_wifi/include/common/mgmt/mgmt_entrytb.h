...
#ifdef GTB_APP_SUPPORT
	struct TxLatencyStats tx_latency_stats;
#endif
#ifdef EAP_STATS_SUPPORT
	UINT32	tx_latency_min;
	UINT32	tx_latency_max;
	UINT64	tx_latency_avg;
#ifdef EAP_ENHANCE_STATS_SUPPORT
	UINT32	air_latency_min;
	UINT32	air_latency_max;
	UINT64	air_latency_avg;
	UINT8	tx_cnt_min;
	UINT8	tx_cnt_max;
	UINT64	tx_cnt_avg;
#endif /* EAP_ENHANCE_STATS_SUPPORT */
	UINT64 tx_pkt_num;
	UINT64 tx_pkt_ret[16];
	UINT64 tx_pkt_ret_dly_avg[16];
	UINT64 tx_pkt_hist[16];
...
#endif /* MAP_R6 */
#ifdef MAP_R6
	ULONG current_assoc_time;
	UCHAR current_assoc_mac[MAC_ADDR_LEN];
#endif /* MAP_R6 */
#endif
