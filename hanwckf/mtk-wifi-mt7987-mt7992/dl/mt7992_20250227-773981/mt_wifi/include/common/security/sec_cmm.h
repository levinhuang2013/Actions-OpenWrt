...
#define IS_AKM_FORCE_PMF_REQUIRED(_AKMMap)                    ((_AKMMap == (1 << SEC_AKM_WPA2PSK_SHA256)) \
															|| (_AKMMap == (1 << SEC_AKM_SAE_SHA256)) \
															|| (_AKMMap == (1 << SEC_AKM_FT_SAE_SHA256)) \
															|| (_AKMMap == (1 << SEC_AKM_SUITEB_SHA256)) \
															|| (_AKMMap == (1 << SEC_AKM_SUITEB_SHA384)) \
															|| (_AKMMap == (1 << SEC_AKM_FT_WPA2_SHA384)) \
															|| (_AKMMap == (1 << SEC_AKM_OWE)) \
															|| (_AKMMap == (1 << SEC_AKM_WPA3)) \
															|| (_AKMMap == (1 << SEC_AKM_SAE_EXT)) \
															|| (_AKMMap == (1 << SEC_AKM_FT_SAE_EXT)))
...
#define IS_CIPHER_CCMP_OR_GCMP(_Cipher)    (IS_CIPHER_CCMP128(_Cipher) || IS_CIPHER_CCMP256(_Cipher) \
											|| IS_CIPHER_GCMP128(_Cipher) || IS_CIPHER_GCMP256(_Cipher))
