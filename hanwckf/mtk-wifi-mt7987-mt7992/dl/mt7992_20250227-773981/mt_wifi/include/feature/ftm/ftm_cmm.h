...
#if defined(MT7990)
#define FTM_BIAS_OFFSET 0xF1000
#elif defined(MT7992)
#define FTM_BIAS_OFFSET 0x15C000
#elif defined(MT7993)
#define FTM_BIAS_OFFSET 0x14A000
#else
#define FTM_BIAS_OFFSET 0x15C000
#endif

#define FTM_BIAS_5G_GROUP1 0
#define FTM_BIAS_5G_GROUP2 1
#define FTM_BIAS_5G_GROUP3 2
...
struct loc_cal_info {
	...
	UINT_8 WF2_Enable: 1;
	UINT_8 WF3_Enable: 1;
	UINT_8 WFx_reserved: 4;
	UINT_8 Reserved[5];
};

struct loc_bias_table_2G {
	UINT_32 CBW20_DBW20;
	UINT_32 CBW40_DBW20;
	UINT_32 CBW40_DBW40;
};

struct loc_bias_table_56G {
	UINT_32 CBW20_DBW20;
	UINT_32 CBW40_DBW20;
	UINT_32 CBW40_DBW40;
	UINT_32 CBW80_DBW20;
	UINT_32 CBW80_DBW40;
	UINT_32 CBW80_DBW80;
	UINT_32 CBW160_DBW20;
	UINT_32 CBW160_DBW40;
	UINT_32 CBW160_DBW80;
	UINT_32 CBW160_DBW160;
};

struct loc_bias_table {
	struct loc_cal_info ftm_cal_info;
	struct loc_bias_table_2G ftm_bias_2G[14];
	struct loc_bias_table_56G ftm_bias_5G[3]; // low, medium, high
	struct loc_bias_table_56G ftm_bias_6G;
};
