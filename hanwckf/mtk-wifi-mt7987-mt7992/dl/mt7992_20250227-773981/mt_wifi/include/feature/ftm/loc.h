...
typedef struct     _LOC_CONFIG_T {
	UINT_16 u2Wcid;                   /* WTBL index */
	UINT_16 u2BurstBringForwardTime;  /* driver channel switch time estimation, unit: ms */
	...
	// bias compensate
	UINT_32 u4BiasPsValueBW20;
	UINT_32 u4BiasPsValueBW40;
	UINT_32 u4BiasPsValueBW80;
	UINT_32 u4BiasPsValueBW160;
