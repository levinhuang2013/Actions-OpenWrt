...
struct mtk_hdev_ops {
	...
	int (*set_particular_to_host)(struct _RTMP_ADAPTER *ad, bool enable);
	u32 (*change_setup_link_sta)(struct _RTMP_ADAPTER *ad, uint16_t wcid);
	int (*get_tx_sw_token_nums_all_band)(PRTMP_ADAPTER ad, u16 *max_tk, u8 array_size);
	void (*get_tx_sw_used_token_by_band)(PRTMP_ADAPTER ad, u16 *used_tk);
};
...
int hc_get_tx_sw_token_nums_all_band(PRTMP_ADAPTER ad, u16 *max_tk, u8 size);
