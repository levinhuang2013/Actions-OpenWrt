...
#endif
	HWCMD_ID_FLUSH_PS_STA_PLE_NUM = 108,
	HWCMD_ID_END,
};
...
VOID RTMP_FLUSH_PS_STA_PLE(struct _RTMP_ADAPTER *pAd, UINT16 pkt_thres, UINT8 band_map);
VOID RTMP_FLUSH_PS_STA_PLE_NUM(struct _RTMP_ADAPTER *pAd, UINT16 flush_num, UINT8 band_map);
...
#ifdef MTK_FE_RESET_RECOVER
	atomic_t notify_to_fe;
	atomic_t notify_from_fe;
