...
#define RX_STREAM_PATH_SINGLE_MODE        5
...
INT AsicSetTxCmdEDCA(struct _RTMP_ADAPTER *pAd, struct wifi_dev *wdev, UINT8 idx, PEDCA_PARM pEdcaParm);
INT AsicSetPerStaWmm(struct _RTMP_ADAPTER *pAd, struct wifi_dev *wdev, UINT16 wcid, UINT8 ac, UINT8 idx);
...
typedef struct _RTMP_ARCH_OP {
	...
	INT (*archUniCmdSetTxCmdEDCA)(struct _RTMP_ADAPTER *pAd, struct wifi_dev *wdev, UINT8 idx, PEDCA_PARM pEdcaParm);
	INT (*archUniCmdSetPerStaWMM)(struct _RTMP_ADAPTER *pAd, struct wifi_dev *wdev, UINT16 wcid, UINT8 ac, UINT8 idx);
#endif /* WIFI_UNIFIED_COMMAND */
	...
	BOOLEAN (*get_wdma_related_tx_bus_info)(u32 wdma_idx);
#endif
#endif /* ERR_RECOVERY */
