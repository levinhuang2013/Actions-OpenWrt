...
typedef struct GNU_PACKED _UNI_CMD_BSSINFO_BCN_MLO_CSA_T {
	...
	UINT16 u2Length;
	UINT16 u2MloCsaIeOffset[3]; /* 3 means band number */
	UINT_8 ucMloCsaBssIdx[3];
	UINT_8 aucPktContent[3];
...
typedef enum _UNI_CMD_EDCA_TAG_T {
	UNI_CMD_EDCA_AC_PARM = 0x00,
	UNI_CMD_EDCA_TXCMD_EDCA_TBL = 0x01,
	UNI_CMD_EDCA_SU_DL_TXCMD = 0x02,
    UNI_CMD_EDCA_MAX_NUM
} UNI_CMD_EDCA_TAG_T;

/* EDCA AC Parameters (Tag 0x00) */
...
/* EDCA TXCMD EDCA Table Parameters (Tag 0x01) */
typedef struct GNU_PACKED _UNI_CMD_EDCA_TXCMD_EDCA_TBL_T {
	UINT16 u2Tag;
	UINT16 u2Length;
	UINT8 ucEdcaTblIdx;
	UINT8 ucCWmin;
	...
	UINT8 ucAifs;
	UINT8 aucPadding[4];
} UNI_CMD_EDCA_TXCMD_EDCA_TBL_T, *P_UNI_CMD_EDCA_TXCMD_EDCA_TBL_T;

/* EDCA SU DL TXCMD Parameters (Tag 0x02) */
typedef struct GNU_PACKED _UNI_CMD_EDCA_SU_DL_TXCMD_T {
	UINT16 u2Tag;
	UINT16 u2Length;
	UINT16 u2WlanIdx;
	UINT8 ucAc;
	UINT8 ucEdcaTblIdx;
	UINT8 aucPadding[4];
} UNI_CMD_EDCA_SU_DL_TXCMD_T, *P_UNI_CMD_EDCA_SU_DL_TXCMD_T;
...
*UNI_CMD_WSYS_CONFIG_FW_FLUSH_PS_PLE_NUM |	0xa|	UNI_CMD_WSYS_CONFIG_FW_PLUSH_PS_PLE_T
*/
};
...
enum UNI_CMD_WSYS_CONFIG_TAG_T {
	...
	UNI_CMD_WSYS_CONFIG_FW_FLUSH_PS_PLE = 8,
	UNI_CMD_WSYS_CONFIG_FW_DUP_MBSS_BCN = 9,
	UNI_CMD_WSYS_CONFIG_FW_FLUSH_PS_PLE_NUM = 10,
...
/* UNI_CMD_WSYS_CONFIG_FW_FLUSH_PS_PLE_T (Tag8) TODO */
struct GNU_PACKED UNI_CMD_WSYS_CONFIG_FW_FLUSH_PS_PLE_T {
	UINT16 u2Tag;
	UINT16 u2Length;
	UINT16 u2PktThres;
	UINT8 ucBandMap;
...
typedef INT32 (*PFN_WSYS_CONFIG_FW_FLUSH_PS_PLE_HANDLE)(struct _RTMP_ADAPTER *pAd,
													struct UNI_CMD_WSYS_CONFIG_FW_FLUSH_PS_PLE_T *pParam,
													VOID *pHandle);
...
struct GNU_PACKED UNI_CMD_WSYS_CFG_PARAM_T {
	...
	struct UNI_CMD_WSYS_CONFIG_FW_FLUSH_PS_PLE_T WsysCfgFwFlushPsPle;
	struct UNI_CMD_FW_DUP_MBSS_BCN_T WsysCfgFw11vBcnCrtl;
	struct UNI_CMD_WSYS_CONFIG_FW_FLUSH_PS_PLE_T WsysCfgFwFlushPsPleNum;
};
...
typedef enum _UNI_CMD_BAND_CONFIG_TAG_T {
	...
	UNI_CMD_BAND_CONFIG_RESERVED_1 = 0x12,
	UNI_CMD_BAND_CONFIG_AP_SNIFFER_MODE = 0x13,
...
struct GNU_PACKED UNI_CMD_BAND_CONFIG_AP_SNIFFER_MODE_T {
	UINT_16 u2Tag;
	UINT_16 u2Length;
	UINT_8 ucNoRxDropEnable;
	UINT_8 ucRxRxvEnable;
	UINT_8  ucDeAmsduEnable;
	UINT_8 aucReserved[5];
};

typedef INT32 (*PFN_BAND_CFG_AP_SNIFFER_MODE_HANDLE)(struct _RTMP_ADAPTER *pAd,
									struct UNI_CMD_BAND_CONFIG_AP_SNIFFER_MODE_T *pParam,
									VOID *pHandle);
...
typedef struct GNU_PACKED _UNI_CMD_BAND_CFG_PARAM_T {
	...
	struct UNI_CMD_BAND_CONFIG_AP_SNIFFER_MODE_T BandCfgApSnifferMode;
...
typedef struct _UNI_CMD_ID_LOCATION_T {
	...
	*   UNI_CMD_LOC_TAG_FTMR_TIMEOUT       | 0x09 | struct _UNI_CMD_LOC_TAG_FTMR_TIMEOUT_T
	*/
...
typedef enum _UNI_CMD_LOC_TAG_T {
	...
	UNI_CMD_LOC_TAG_FTMR_TIMEOUT = 9,
	UNI_CMD_LOC_TAG_NUM
} UNI_CMD_LOC_TAG_T;
...
struct _UNI_CMD_LOC_TAG_FTMR_TIMEOUT_T {
	UINT_16 u2Tag;
	UINT_16 u2Length;
	UINT_32 u4FTMRTimeout; // ms
};

typedef INT32 (*PFN_LOC_TAG_FTMR_TIMEOUT_HANDLE)(struct _RTMP_ADAPTER *pAd,
										UINT32 timeout,
										VOID *pHandle);
...
enum GNU_PACKED UNI_CMD_ID_RA_TAG {
	...
	UNI_CMD_RA_SET_FIXED_RATE_UL_TRIG = 0x10,
	UNI_CMD_RA_SET_AUTO_RATE = 0x11,
	UNI_CMD_RA_GET_FIXED_RATE_PER_AC = 0x13,
	UNI_CMD_RA_MAX_NUM
};
...
struct GNU_PACKED _UNI_CMD_RA_GET_FIXED_RATE_PER_AC_T {
	UINT16 u2Tag;
	UINT16 u2Length;

	/* tag specific part */
	UINT16 u2WlanIdxPerAcFixedRateList[8];
};
...
INT32 UniCmdSetApSnifferMode(struct _RTMP_ADAPTER *pAd, struct wifi_dev *wdev, UINT8 ucNoRxDropEnable,
	UINT8 ucRxRxvEnable, UINT8 ucDeAmsduEnable);
...
INT32 MTUniCmdFlushPsStaPle(struct _RTMP_ADAPTER *pAd, UINT16 u2PktThres, UINT8 ucBandMap);

INT32 MTUniCmdFlushPsStaPleNum(struct _RTMP_ADAPTER *pAd, UINT16 u2PktThres, UINT8 ucBandMap);
...
INT32 UniCmdRAGetFixedRatePerAcProc(
	struct _RTMP_ADAPTER *pAd,
	IN RTMP_STRING * arg);
