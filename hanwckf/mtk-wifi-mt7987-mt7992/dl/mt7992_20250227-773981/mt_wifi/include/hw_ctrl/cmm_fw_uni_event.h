...
enum UNI_EVENT_RA_TAG {
	...
	UNI_EVENT_RA_FIXED_RATE_PER_AC_INFO = 4,
...
struct  GNU_PACKED _UNI_EVENT_FIXED_RATE_PER_AC_INFO_T {
	UINT16 u2Tag;
	UINT16 u2Length;
...
enum _UNI_EVENT_ID_LOCATION_TAG_T {
	...
	UNI_EVENT_LOC_TAG_NASAP_NEGO_RESULT = 8,
...
struct _UNI_EVENT_LOC_NASAP_NEGO_RESULT_T {
	UINT_16 u2Tag;
	UINT_16 u2Length;
	UINT_16 u2Wcid;
	...
	UINT_8 aucAddr[MAC_ADDR_LEN];
	UINT_8 eType;
	UINT_8 ucSeitchChannel;
	UINT_32 u4TSFSyncInfo;
};
...
/* ============== UNI_EVENT_ID_EPCS END ============ */

/* ============== UNI_EVENT_ID_BSS_MATCH Start ============ */
...
/* ============== UNI_EVENT_ID_BSS_MATCH End ============ */

/* ============== UNI_EVENT_ID_BSSINFO 0x74 Start ============== */
enum UNI_EVENT_BSSINFO_TAG_T {
	UNI_EVENT_BSSINFO_BCN_CRI_UPD = 0x01,	/*unsolicited*/
};

struct GNU_PACKED UNI_EVENT_BSSINFO_T {
    /* fixed field */
	UINT8 ucBssInfoIdx;
	UINT8 aucPadding[3];
...
/* Event BssInfo BCN BSS Parameter Critical Update (Tag 0x01) */
struct GNU_PACKED UNI_EVENT_BSSINFO_BCN_CRIT_UPD_T {
	UINT16 u2Tag;       /* Tag = 0x01 */
	UINT16 u2Length;
	UINT8 aucPadding[4];
};

/* ============== UNI_EVENT_ID_BSSINFO 0x74 End ============== */
