...
typedef enum _ENUM_EXT_CMD_CR4_SET_ID_T {
	...
	WA_SET_OPTION_PER_BSS_RETRY = 0xa3,
#endif
	WA_SET_OPTION_PER_AC_RETRY = 0xa4,
	CR4_SET_ID_NUM
...
enum EXT_CMD_TYPE {
	...
	EXT_CMD_ID_ARP_FLOW_CONTROL = 0xD6,
...
typedef struct GNU_PACKED _EXT_CMD_CFG_SET_ACK_CTS_T {
	...
	UINT8	u1Type; /* 0: CCK DCF Timeout, 1: OFDM DCF Timeout, 2: OFDMA-MU DCF Timeout */
	UINT8	aucReserved[3];
...
struct GNU_PACKED _EXT_CMD_ID_ARP_FLOW_CONTROL {
	UINT8 ucEnable;
	UINT16 threshold;
	UINT8 arp_disable_fr;
};
...
#ifdef IGMP_SNOOPING_OFFLOAD
struct GNU_PACKED _EXT_CMD_ID_UNICAST_ALL {
	UINT8 ucUnicastAllEnable; /* 0: Disable, 1: Enable */
	UINT8 uc_omac_idx;
	UINT8 uc_band_idx;
	UINT8 uc_bss_idx;
};
#endif /* IGMP_SNOOPING OFFLOAD */
...
INT32 CmdArpFlowControlEnable(struct _RTMP_ADAPTER *pAd, UCHAR Enable, UINT16 threshold, UCHAR disable_fr);

#ifdef IGMP_SNOOP_SUPPORT
INT32 CmdMcastCloneEnable(struct _RTMP_ADAPTER *pAd, BOOLEAN Enable, UINT8 band_idx, UINT8 omac_idx);
#ifdef IGMP_SNOOPING_OFFLOAD
INT32 CmdUnicastAllEnable(struct _RTMP_ADAPTER *pAd, BOOLEAN Enable, UINT8 band_idx, UINT8 omac_idx, UINT8 bss_idx);
#endif /* IGMP_SNOOPING_OFFLOAD */
