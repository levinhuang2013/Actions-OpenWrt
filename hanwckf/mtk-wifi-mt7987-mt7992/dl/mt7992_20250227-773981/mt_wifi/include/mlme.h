...
#define HAS_EHT_ML_T2LM_EXIST(exist) ((exist) & EHT_ML_T2LM_EXIST)
...
#define SET_EHT_ML_T2LM_EXIST(exist) ((exist) |= EHT_ML_T2LM_EXIST)
...
#define CLR_EHT_ML_T2LM_EXIST(exist) ((exist) &= (~EHT_ML_T2LM_EXIST))
...
typedef struct _bcn_ie_list {
	...
	struct tid2lnk_ie_info t2lm_info;
#endif
} BCN_IE_LIST;
