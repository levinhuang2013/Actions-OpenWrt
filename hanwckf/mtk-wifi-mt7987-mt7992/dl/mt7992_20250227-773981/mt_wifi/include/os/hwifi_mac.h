...
struct mtk_mac_hw_ops {
	...
	int (*get_info)(struct mtk_mac_hw *hw, enum mtk_mac_info info_type, void *info);
	int (*set_info)(struct mtk_mac_hw *hw, enum mtk_mac_info info_type, void *info);
	...
	int (*get_tx_sw_token_nums_all_band)(struct mtk_mac_hw *hw, u16 *max_tk, u8 array_size);
	void (*get_tx_sw_used_token_by_band)(struct mtk_mac_hw *hw, u16 *used_tk);
};
