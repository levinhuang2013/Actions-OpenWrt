...
#define DOT11BE_TID2LNK_MAP_CTRL_MST_SHIFT 3
#define DOT11BE_TID2LNK_MAP_CTRL_MST_BITS 1
#define DOT11BE_TID2LNK_MAP_CTRL_MST_MASK \
	CAP_BITS_MASK(DOT11BE_TID2LNK_MAP_CTRL_MST)

#define DOT11BE_TID2LNK_MAP_CTRL_ED_SHIFT 4
#define DOT11BE_TID2LNK_MAP_CTRL_ED_BITS 1
#define DOT11BE_TID2LNK_MAP_CTRL_ED_MASK \
	CAP_BITS_MASK(DOT11BE_TID2LNK_MAP_CTRL_ED)

#define DOT11BE_TID2LNK_MAP_CTRL_LINK_MAP_SIZE_SHIFT 5
#define DOT11BE_TID2LNK_MAP_CTRL_LINK_MAP_SIZE_BITS 1
#define DOT11BE_TID2LNK_MAP_CTRL_LINK_MAP_SIZE_MASK \
	CAP_BITS_MASK(DOT11BE_TID2LNK_MAP_CTRL_LINK_MAP_SIZE)

#define DOT11BE_TID2LNK_MAP_CTRL_RESERVED_SHIFT 6
#define DOT11BE_TID2LNK_MAP_CTRL_RESERVED_BITS 2
#define DOT11BE_TID2LNK_MAP_CTRL_RESERVED_MASK \
	CAP_BITS_MASK(DOT11BE_TID2LNK_MAP_CTRL_RESERVED)
...
#define SET_DOT11BE_TID2LNK_MAP_CTRL_MST(_capinfo, _value) \
	SET_CAP_BITS(DOT11BE_TID2LNK_MAP_CTRL_MST, _capinfo, _value)
#define GET_DOT11BE_TID2LNK_MAP_CTRL_MST(_capinfo) \
	GET_CAP_BITS(DOT11BE_TID2LNK_MAP_CTRL_MST, _capinfo)

#define SET_DOT11BE_TID2LNK_MAP_CTRL_ED(_capinfo, _value) \
		SET_CAP_BITS(DOT11BE_TID2LNK_MAP_CTRL_ED, _capinfo, _value)
#define GET_DOT11BE_TID2LNK_MAP_CTRL_ED(_capinfo) \
		GET_CAP_BITS(DOT11BE_TID2LNK_MAP_CTRL_ED, _capinfo)

#define SET_DOT11BE_TID2LNK_MAP_CTRL_LINK_MAP_SIZE(_capinfo, _value) \
	SET_CAP_BITS(DOT11BE_TID2LNK_MAP_CTRL_LINK_MAP_SIZE, _capinfo, _value)
#define GET_DOT11BE_TID2LNK_MAP_CTRL_LINK_MAP_SIZE(_capinfo) \
	GET_CAP_BITS(DOT11BE_TID2LNK_MAP_CTRL_LINK_MAP_SIZE, _capinfo)

#define SET_DOT11BE_TID2LNK_MAP_CTRL_RESERVED(_capinfo, _value) \
	SET_CAP_BITS(DOT11BE_TID2LNK_MAP_CTRL_RESERVED, _capinfo, _value)
#define GET_DOT11BE_TID2LNK_MAP_CTRL_RESERVED(_capinfo) \
	GET_CAP_BITS(DOT11BE_TID2LNK_MAP_CTRL_RESERVED, _capinfo)
...
/*
 * Indicates the exponent extension for the maximum A-MPDU length
 * supported in reception. (BIT8)
*/
#define DOT11BE_MAC_CAP_MAX_AMPDU_LEN_EXP_SHIFT 8
#define DOT11BE_MAC_CAP_MAX_AMPDU_LEN_EXP_MASK \
	BIT(DOT11BE_MAC_CAP_MAX_AMPDU_LEN_EXP_SHIFT)
#define SET_DOT11BE_MAC_CAP_AMPDU_LEN_EXP(_capinfo, _value) \
	SET_CAP_BITS(DOT11BE_MAC_CAP_MAX_AMPDU_LEN_EXP, _capinfo, _value)
#define GET_DOT11BE_MAC_CAP_MAX_AMPDU_LEN_EXP(_capinfo) \
	GET_CAP_BITS(DOT11BE_MAC_CAP_MAX_AMPDU_LEN_EXP, _capinfo)
