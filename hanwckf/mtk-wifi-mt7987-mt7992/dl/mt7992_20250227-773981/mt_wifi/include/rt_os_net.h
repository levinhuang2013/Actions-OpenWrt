...
#define RTMP_DRIVER_80211_AP_BEACON_KEY_DEFAULT_SET(__pAd, __pNdev, __KeyId)				\
	RTMP_COM_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_80211_AP_BEACON_KEY_DEFAULT_SET, 0, __pNdev, __KeyId)
...
#define RTMP_DRIVER_80211_AP_BIND_VLAN(__pAd, __pEntry, __VlanId) \
	RTMP_COM_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_BIND_VLAN, 0, __pEntry, __VlanId)
#endif
