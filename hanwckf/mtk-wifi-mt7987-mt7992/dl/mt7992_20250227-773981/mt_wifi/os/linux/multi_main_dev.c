...
UINT8 CurrentPrintkDebugLevel = 0;
module_param(CurrentPrintkDebugLevel, byte, 0644);
MODULE_PARM_DESC(CurrentPrintkDebugLevel, "Current debug log level of printk");
